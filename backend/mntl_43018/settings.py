"""
Django settings for mntl_43018 project.
...
WSGI_APPLICATION = 'mntl_43018.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mntl_43018 API",
    "DESCRIPTION": "API documentation for mntl_43018 App",
    "VERSION": "v1",
}
